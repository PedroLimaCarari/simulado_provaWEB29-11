      ...
      <div className='flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white'>
        ...
        <div className='mx-auto w-full max-w-sm lg:w-96'>
          <div>
            ...
            <h2 className='mt-6 text-3x1 font-semibold text-blue-700'>Cadastro</h2>
          </div>
          <div className='mt-6'>
            <form action="">
                <div className='mb-4'>
                ...
                <div className='mb-4'>
                    <button type='button' onClick={()=> router.push('/login')} className='inline-block w-full py-4 px-8 leading-none text-white bg-blue-700 hover:bg-blue-900 font-semibold rounded shadow'>Efetuar Cadastro</button>
                </div>
            </form>
          </div>
        </div>
